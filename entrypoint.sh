...
if [ ! -f /config/ownsettings.php ] && [ -f /usr/local/apache2/htdocs/spotweb/ownsettings.php ]; then
  cp /usr/local/apache2/htdocs/spotweb/ownsettings.php /config/ownsettings.php
fi

touch /config/ownsettings.php 
rm -f /usr/local/apache2/htdocs/spotweb/ownsettings.php
ln -s /config/ownsettings.php /usr/local/apache2/htdocs/spotweb/ownsettings.php
...
if [ -f /config/dbsettings.inc.php ]; then
	chown apache:apache /config/dbsettings.inc.php
	rm /usr/local/apache2/htdocs/spotweb/dbsettings.inc.php
	ln -s /config/dbsettings.inc.php /usr/local/apache2/htdocs/spotweb/dbsettings.inc.php
else
...
# Run database update
#if 
#/usr/bin/php /usr/local/apache2/htdocs/spotweb/bin/upgrade-db.php
...
#httpd-foreground
#tail -F /usr/local/apache2/logs/* /dev/stdout /dev/stderr
